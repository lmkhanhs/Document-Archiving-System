...
import ManagerDocument from "./components/ManagerDocument";
import {
  CartesianGrid,
  Cell,
  Legend,
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    let isMounted = true;
    setIsDocumentStatsLoading(true);
    ...
    Promise.all([
      ...
      .finally(() => {
        if (isMounted) {
          setIsDocumentStatsLoading(false);
        }
      });
        ...
        <main className="flex-1 p-4 md:p-6">
          ...
          {activeMenu === "users" ? (
            ...
            <ManagerDocument
              ...
              onRefreshDocuments={() => setDocReloadKey((prev) => prev + 1)}
              onShowDetail={setDocDetail}
              onPreview={handleDocPreview}
              onSummary={handleDocSummaryOpen}
              onDownload={handleDocDownload}
              onRestore={handleDocRestore}
              onOpenDeleteDialog={openDocDeleteDialog}
              getFileIconMeta={getFileIconMeta}
              getAvatarLabel={getAvatarLabel}
