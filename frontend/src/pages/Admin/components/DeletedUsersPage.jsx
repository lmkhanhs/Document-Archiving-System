...
const statusBadgeClass = "bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-400 border-slate-200";
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          ...
                          className="rounded-lg border border-slate-200 dark:border-slate-700 p-2 text-rose-600 transition hover:bg-rose-50"
                          title="Xoa vinh vien"
